...
export default function Search(){
    ...
    async function handleSearch(){
        ...
        if(response.data.by === 'default'){
            setError('hmm, Cidade não econtrada :(');
            setInput('');
            setCity(null);
            Keyboard.dismiss();
            return;
        ...
        return(
            ...
            colors={['#1ed6ff', '#97c1ff']}>
                ...
                <View>
                    ...
                    <Text style={styles.textTemp}>{city.results.description}</Text>
                    <Text style={styles.textTime}>{city.results.time}</Text>
                </View>
    ...
    return(
        <SafeAreaView style={styles.container}>
            ...
            {error && <Text style={{fontSize:18, fontWeight:'bold', marginTop:25}}>{error}</Text>}
        </SafeAreaView>
    );
}
